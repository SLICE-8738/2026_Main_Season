...
public class Buttons {
     ...
     * 
     * public static XboxController controller2 = new
     * XboxController(Constants.OIConstants.kOperatorControllerPort);
     * 
     * public static Trigger controller2_AButton = new JoystickButton(controller2,
     * 1);
     * public static Trigger controller2_BButton = new JoystickButton(controller2,
     * 2);
     * public static Trigger controller2_XButton = new JoystickButton(controller2,
     * 3);
     * public static Trigger controller2_YButton = new JoystickButton(controller2,
     * 4);
     * public static Trigger controller2_leftBumper = new
     * JoystickButton(controller2, 5);
     * public static Trigger controller2_rightBumper = new
     * JoystickButton(controller2, 6);
     * public static Trigger controller2_minusButton = new
     * JoystickButton(controller2, 7);
     * public static Trigger controller2_plusButton = new
     * JoystickButton(controller2, 8);
     * public static Trigger controller2_pressLeftStick = new
     * JoystickButton(controller2, 9);
     * public static Trigger controller2_pressRightStick = new
     * JoystickButton(controller2, 10);
     * public static Trigger controller2_RightTrigger = new Trigger(() ->
     * controller2.getRawAxis(2) > 0.1);
     * public static Trigger controller2_LeftTrigger = new Trigger(() ->
     * controller2.getRawAxis(3) > 0.1);
     * 
     */
