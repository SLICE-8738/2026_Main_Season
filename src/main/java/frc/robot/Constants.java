...
public final class Constants {
  ...
  public static class ShooterConstants {
    ...
    public static final double SHOOTER_STOW = 12.0; // The angle at which the shooter is considered stowed (degrees)
    ...
    public static final double FLYWHEEL_RADIUS = Units.inchesToMeters(2); // Feet
    public static final double LIMELIGHT_ANGLE = 90 - 72.5; // TODO: Fill in degrees
